...
const SHOP_ITEMS = [
  {
    ...
    tagLabel: 'COOLING',
    shortDesc: '冷卻降頻免疫，維護期間的神器',
    effects: [
      { icon: '❄️', text: '啟動冷卻系統，30 分鐘內免疫「系統維護」降頻' },
      { icon: '🛡️', text: '維護期間健康度不再自然衰減' },
      { icon: '💎', text: '維護期間額外 PT 收益 +0.05/tic' },
    ],
    tip: '「系統維護模式」期間使用，可無視 0.5 倍降頻懲罰，還能額外累積 PT！',
  },
  {
    id: 'quantum_cooler',
    name: '量子散熱塔',
